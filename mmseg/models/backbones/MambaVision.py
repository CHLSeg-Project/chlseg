...
class MambaVisionMixer(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        if selective_scan_fn is None:
            raise ImportError(
                "mamba_ssm is required for MambaVision. "
...
if MODELS_MMDET is not None:
    MODELS_MMDET.register_module()(MM_mamba_vision)


@MODELS_MMSEG.register_module()
class MambaVisionSeg(MM_mamba_vision):
    """Alias for compatibility with existing mmseg configs."""
    pass