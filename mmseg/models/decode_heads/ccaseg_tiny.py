...
class LKCA2(BaseModule):
    def __init__(self, channels1, channels2, norm_cfg=dict(type='SyncBN', requires_grad=True), act_cfg=dict(type='GELU'), 
        ...
        self.conv3b = nn.Conv2d(channels1, channels1, 1)
...
class CCASegHead_tiny(BaseDecodeHead):
    def __init__(self, feature_strides, **kwargs):
        ...
        # SFI: F̂_1 (c1_pool) → F̂_2 (c2_pool) injection for first I in SFI of Blocks 1-3
        self.multi8_5 = Inject(dim1=c1_in_channels, dim2=c2_in_channels)
        self.multi16_5 = Inject(dim1=c1_in_channels, dim2=c2_in_channels)
        self.multi32_5 = Inject(dim1=c1_in_channels, dim2=c2_in_channels)
        ...
        # SFI for Block 4 (target = c1_pool): integrates {O_2, O_3, O_4}
        self.multi64_5 = Inject(dim1=c1_in_channels, dim2=c2_in_channels)
        ...
        # Prediction-side SFI: integrates {O_1, O_2, O_3, O_4} at 64×64
    ...
    def forward(self, inputs):
        ...
        # F1-Pooling: c1 stride=4 → pooled to 64/32/16
        c1_64 = self.down1_1(c1) # 64x64 (= T_1 in paper, also used as target of Block 4)
        c1_32 = self.down1_2(c1) # 32x32
        c1_16 = self.down1_3(c1) # 16x16

        # Block 1: target = c4 (16x16). SFI = I(I(I(c1↓, c2↓), c3↓), c4)
        ...
        # Block 2: target = c3 (32x32). SFI = I(I(I(c1↓, c2↓), c3), O_4↑)
        ...
        # Block 3: target = c2 (64x64). SFI = I(I(I(c1↓, c2), O_3↑), O_4↑)
        ...
        # Block 4: target = c1_pool (64x64). SFI = I(I(I(T_1, O_2), O_3↑), O_4↑)
        ...
        # Prediction-side SFI: integrate {O_1, O_2, O_3, O_4}
