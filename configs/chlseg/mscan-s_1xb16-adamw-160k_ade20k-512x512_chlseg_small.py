# CHLSegHead_small on MSCAN-S backbone for ADE20K 160k. Mirrors the tiny
# config; backbone is overridden to load mscan_s pretrained weights, and the
# decode head's in_channels / embed_dim are raised to match MSCAN-S widths.
_base_ = '../segnext/segnext_mscan-s_1xb16-adamw-160k_ade20k-512x512.py'

work_dir = 'work_dirs/chlseg_small'
